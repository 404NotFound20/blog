...
/**
 * @Classname SmsUtils
 * @Description 腾讯云短信api
 * @Date 2022/1/3 1:19 下午
 * @Created by zenghui
 */
@Slf4j
@Data
@Component
@ConfigurationProperties(prefix = "ender.sms")
...
//            String[] phoneNumberSet = {"+8618795973139", "+8612345678902", "+8612345678903"};
            String[] phoneNumberSet = {"+8618795973139"};
